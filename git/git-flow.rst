...
開発の現場でバージョン管理システムを導入する際に、SubversionよりGitを採用しようという話を時々聞きます。また、GitのホスティングサービスであるGithub [#github]_ にアカウントを持っているエンジニアも増えています。というわけでこれからはGitです。Gitが普通に使えるエンジニアがイケてるエンジニアですね！
...
*****************************************
git & git-flow の環境構築手順(MacOSX編)
*****************************************

Windows編ですが難しかったので記載してません。ごめんなさい…。
