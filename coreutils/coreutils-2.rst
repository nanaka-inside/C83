...
必要なときにしか読まないマニュアルをあえて解説するという暴挙にでました。筆者がよく使っているコマンドがよくわかりますね [#core-owarini1]_ 。
打ったことないコマンドがあると思いますが [#core-owari2]_ 是非打ってみて下さい。世界が広がります。
もしかしたら、今行っている作業が簡略化できたり、組み合わせることによってこれまで出来なかったことが出来るようになります。突然の仕事にも、効果があるかもしれません [#core-warini3]_ 。

このコマンドを俺が一番うまく使えるんだ！という Tips をお持ちの方、この環境だとこの辺でこけるといった検証報告をお持ちの方、この説明違うよ!全然違うよ!!ということを思われた方は、筆者 [#hissya]_ まで連絡を頂けると大変ありがたいです。
