...
shred
~~~~~~
爆ぜたり弾けたりしていた黒歴史を強力に清算するコマンドです。ハードディスクの中身を何度も上書きを行って黒歴史を清算し、復元される可能性を減らします [#shared]_ 。
...
一つ付け加えることとして、シンボリックリンクの上書きオプション(-f)があります。シンボリックリンクの中身をファイルで開いていたりすると上書きできないので注意して下さい。上書きできた！と思っても、リンクが変わっていることを確認しましょう。

そのほかのオプションとしては、シンボリックリンクからハードリンクを作成するオプションというのがありましたが誰得感強いです。

.. [#ln-i] inodeって出てきましたよね？
...
.. [#mknod-g] なんかこう、命令されそうですけど。zeroだけに
